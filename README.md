...
<body >
    ...
    <h1><center>WELCOME TO SOF TECH</center></h1>
    <h2>Biggest company in Asia</h2>
    <h2>PRODUCTS</h2>
    <a href="sign.html">
...
<footer style="background-color:violet;margin-top: 64; border: none;">
    <P style="color:#ffffff; ;"align="center">Designed and Devoloped by PRASANNA L 2024 </P>
</footer>
</html>
...
<body>
    ...
    <div class="photos">
        <img src="ajay.jpg" height="200" width="170">
        <img src="1.jpg" height="200" width="170">
        <img src="srini.jpg" height="200" width="170">
        <img src="tamil.jpg" height="200" width="170">
        <img src="thiru.jpg" height="200" width="170">
        <img src="mat.jpg" height="200" width="170">
        <img src="PS.jpg" height="200" width="170">
</div>
<div CLASS="names">
    <P>MR THIRU</P>    
    <P style="margin-left:-20;">MR AJAY</P>    
    <P>MR TAMIL</P>    
    <P>MR THULASI</P>    
    <P>MR SRINI</P>    
    <P>MS MATLIN</P>    
...
<html>
    ...
    <body>
        ...
        <img src="product.png" height="500" width="800">
    </center>
    </body>
    <footer style="background-color:violet;margin-top: 64; border: none;">
        <P style="color:#ffffff; ;"align="center">Designed and Devoloped by PRASANNA L 2024 </P>
...
<body>
    ...
    <div class="company">
       ...
       <p> <b >Address</b></p>
        <p >39F9/6,Karmega nadar street,rajapalayam</p>
        <p >rjpm Post</p>
        <p >Rjpm-606 122</p>
        <b >Email:</b>
        <p >prasannal2003@gmail.com</p>
        <b >Phone</b>
        <p >9524140982</p>
    </center>
    </div>
